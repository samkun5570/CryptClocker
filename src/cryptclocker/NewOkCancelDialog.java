 ...
 */   
/**
 * This  Dialog is shown after completion of certain to inform user of task completion 
 * and to show or redirect to the output content
 */
public class NewOkCancelDialog extends javax.swing.JDialog {
     ...
     * @param ed
     */
    public NewOkCancelDialog(java.awt.Frame parent, boolean modal,final TableDemo ed) {
        super(parent, modal);
        this.ed = ed;
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setToolTipText("Click this button to open the folder containing the the content");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/App-Task-Manager-icon.png"))); // NOI18N
        jLabel1.setText("Task have been performed.Please click show");
 ...
 try {
                Desktop.getDesktop().open(new File(ed.pd));
